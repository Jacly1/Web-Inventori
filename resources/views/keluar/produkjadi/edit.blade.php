    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <div class="float-start">Edit Produk Jadi Keluar</div>
                <div class="float-end">
                    <a href="{{ route('keluarproduk.index') }}" class="btn btn-primary btn-sm">&larr; Kembali</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('keluarproduk.update', $keluarProduk->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <select class="form-select @error('barang_id') is-invalid @enderror" id="barang_id" name="barang_id">
                                ...
                                @foreach ($produkJadi as $item)
                                    <option value="{{ $item->barang_id }}" {{ $keluarProduk->barang_id == $item->barang_id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="number" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" name="jumlah" value="{{ old('jumlah', $keluarProduk->jumlah) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control @error('tgl_keluar') is-invalid @enderror" id="tgl_keluar" name="tgl_keluar" value="{{ old('tgl_keluar', $keluarProduk->tgl_keluar) }}">
