...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('masukkemasan.update', $masukKemasan->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <select class="form-select @error('barang_id') is-invalid @enderror" id="barang_id" name="barang_id">
                                ...
                                <option value="{{ $item->barang_id }}" {{ $masukKemasan->barang_id == $item->barang_id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="number" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" name="jumlah" value="{{ old('jumlah', $masukKemasan->jumlah) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" id="tgl_masuk" name="tgl_masuk" value="{{ old('tgl_masuk', $masukKemasan->tgl_masuk) }}">
