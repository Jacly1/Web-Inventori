...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('masukproduk.store') }}" method="post">
                    @csrf
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Tambah Produk Jadi Masuk">
                    </div>
                </form>
            </div>
        </div>
