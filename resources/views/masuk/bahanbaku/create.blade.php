...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('masukbahan.store') }}" method="post">
                    @csrf
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <select class="form-select @error('barang_id') is-invalid @enderror" id="barang_id" name="barang_id">
                                ...
                                <option value="{{ $bahan->barang_id }}" {{ old('barang_id') == $bahan->barang_id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Tambah Bahan Masuk">
                    </div>
                </form>
            </div>
        </div>
