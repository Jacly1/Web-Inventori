...
class RoleController extends Controller
{
    ...
    public function store(StoreRoleRequest $request): RedirectResponse
    {
        ...
        $permissions = Permission::whereIn('id', $request->permissions)->get(['name']); // Tidak perlu toArray()
    ...
    public function edit(Role $role): View
    {
        ...
        $rolePermissions = DB::table('role_has_permissions')
            ...
            ->pluck('permission_id')
            ->toArray(); // Mengambil id permission yang terkait dengan role
    ...
    public function update(UpdateRoleRequest $request, Role $role): RedirectResponse
    {
        ...
        $permissions = Permission::whereIn('id', $request->permissions)->get(['name']);
        $role->syncPermissions($permissions);
